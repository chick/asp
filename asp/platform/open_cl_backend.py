...
class OpenClBackend(ASPBackend):
    ...
    def run_hello():
        ...
        with open(file_name, "w") as f:
            f.write(OpenClBackend.apple_hello_world)
            f.close()
        ...
        if subprocess.call(command.split(' ')) != 0:
            return False
        return subprocess.call(compiled_name) == 0

    apple_hello_world = """
//
// File:       hello.c
//
// Source:     https://developer.apple.com/library/mac/samplecode/OpenCL_Hello_World_Example/Introduction/Intro.html
//
...
if __name__ == '__main__':
    print "run hello returns %s" % OpenClBackend.run_hello()
    print "run hello returns %s" % OpenClBackend.run_hello()
